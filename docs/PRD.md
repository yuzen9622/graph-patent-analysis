...
h1 { font-family: 'Crimson Pro', serif; font-size: 2rem; font-weight: 700; line-height: 1.3; }
h2 { font-family: 'Crimson Pro', serif; font-size: 1.5rem; font-weight: 600; line-height: 1.4; }
h3 { font-family: 'Crimson Pro', serif; font-size: 1.25rem; font-weight: 600; line-height: 1.4; }

/* 內文（Atkinson Hyperlegible） */
body { font-family: 'Atkinson Hyperlegible', sans-serif; font-size: 1rem; line-height: 1.6; }

/* 數據標籤 / 圖譜節點 */
.label-sm { font-family: 'Atkinson Hyperlegible', sans-serif; font-size: 0.75rem; line-height: 1.5; }
...
*本文件由 Claude Code 協助撰寫，基於現有 `src/main.py` 程式碼分析及 `graphify-out/` 圖譜資料。*
