	...
	return (
		<Collapsible open={open} onOpenChange={setOpen} className={className}>
			<div className="flex items-start gap-1">
				<CollapsibleTrigger className="group flex w-full min-w-0 flex-1 items-center gap-2 rounded-md px-1.5 py-2.5 -mx-1.5 hover:bg-muted/70 transition-colors cursor-pointer text-left">
					{icon && (
