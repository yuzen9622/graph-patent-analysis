	...
	return (
		<AccordionItem value={value} className={className}>
			<div className="flex items-start gap-1">
				<AccordionTrigger className="min-w-0 flex-1 items-center gap-2 px-1.5 py-2.5 -mx-1.5 text-xs font-semibold tracking-wide hover:no-underline hover:bg-muted/70 cursor-pointer">
					{icon && (
